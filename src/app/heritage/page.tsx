        ...
        <div className="container-luxury">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <Reveal delay={0.1}>
              ...
              <h2 className="font-display text-3xl sm:text-4xl text-ink mb-6 leading-tight tracking-[0.5px]">
            ...
            <Reveal delay={0.3} className="relative w-full aspect-[4/5] max-w-md mx-auto lg:mx-0 overflow-hidden border border-ink-soft/10 rounded-2xl">
              <Image
      ...
      <section className="section bg-panel border-t border-ink-soft/10">
        <div className="container-luxury">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {/* Pillar 1 */}
            <Reveal delay={0.1} className="flex flex-col gap-6 p-8 border border-ink-soft/10 bg-canvas/50 hover:border-gold/30 transition-colors duration-500">
              <span className="font-display text-4xl text-gold-dim">01</span>
              <h3 className="font-display text-xl text-ink font-medium tracking-[0.5px]">
                Architectural Draping
              </h3>
              <p className="font-body text-ink-soft/70 text-xs leading-relaxed font-light">
      ...
      <section className="section bg-canvas">
        <div className="container-luxury text-center max-w-3xl mx-auto">
          <Reveal>
            ...
            <p className="font-accent text-lg text-ink-soft/80 italic mb-8 leading-relaxed">
